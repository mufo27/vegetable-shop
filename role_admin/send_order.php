...
if (isset($_GET['send_order'])) {
    ...
    $check_send_status = $_GET['send_order'];
    ...
    if ($check_send_status === '1' || $check_send_status === '2' || $check_send_status === '3') {
        ...
        if ($check_send_status === '1') {
            ...
            $btn_send_status = '<a href="send_order.php?send_order" class="btn btn-outline-dark waves-effect waves-themed">ทั้งหมด</a>
                                <a href="send_order.php?send_order=1" class="btn btn-dark waves-effect waves-themed">ยังไม่จัดส่ง</a>
            ...
            $btn_send_status = '<a href="send_order.php?send_order" class="btn btn-outline-dark waves-effect waves-themed">ทั้งหมด</a>
                                ...
                                <a href="send_order.php?send_order=2" class="btn btn-dark waves-effect waves-themed">รอการจัดส่ง</a>
                                <a href="send_order.php?send_order=3" class="btn btn-outline-dark waves-effect waves-themed">จัดส่งแล้ว</a>
                                ';
        } else {
            ...
            $btn_send_status = '<a href="send_order.php?send_order" class="btn btn-outline-dark waves-effect waves-themed">ทั้งหมด</a>
                                <a href="send_order.php?send_order=1" class="btn btn-outline-dark waves-effect waves-themed">ยังไม่จัดส่ง</a>
                                <a href="send_order.php?send_order=2" class="btn btn-outline-dark waves-effect waves-themed">รอการจัดส่ง</a>
                                <a href="send_order.php?send_order=3" class="btn btn-dark waves-effect waves-themed">จัดส่งแล้ว</a>
                                ';
        }
                                                    ...
                                                    <div class="modal fade" id="send-modal<?= $row['orders_id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="action/send_order_db.php" method="post" enctype="multipart/form-data">

                                                                    <input type="hidden" name="send_id" value="<?= $row['send_id']; ?>" required>
                                                                    <input type="hidden" name="send_order" value="<?= $check_send_status; ?>" required>
